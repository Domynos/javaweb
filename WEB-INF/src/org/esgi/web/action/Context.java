...
public class Context implements IContext {
	...
	public Map<String, Object> mapParameters = new HashMap<String, Object>();
	public Map<String, Object> mapFragment = new HashMap<String, Object>();
	public Map<String, Object> mapAttribut = new HashMap<String, Object>();
	public List<String> onJsReady = new ArrayList<String>();
	public List<String> jsUrls = new ArrayList<String>();
